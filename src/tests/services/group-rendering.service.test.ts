...
import { GroupRenderingControlService } from '../../services/group-rendering-control.service';
...
describe('GroupRenderingControlService', () => {
  ...
  describe('GetGroupMute()', () => {
    it('works', async () => {
      ...
      expect(result.CurrentMute).toBe(false);
    });
  });
  ...
  describe('GetGroupVolume()', () => {
    it('works', async () => {
      ...
      expect(result.CurrentVolume).toEqual(10);
    });
  });
