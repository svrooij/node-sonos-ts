...
describe('ConnectionManagerService', () => {
  ...
  describe('GetCurrentConnectionIDs()', () => {
    it('works', async () => {
      ...
      expect(result).toHaveProperty('CurrentConnectionIDs');
    });
  });
  ...
  describe('GetProtocolInfo()', () => {
    it('works', async () => {
      ...
      expect(result).toHaveProperty('Sink');
    });
  });
  ...
  describe('Event parsing', () => {
    it('works', (done) => {
      ...
      service.Events.once('serviceEvent', (data) => {
        expect(data.CurrentConnectionIDs).toBeUndefined();;
        expect(data.SourceProtocolInfo).toBeUndefined();;
        expect(data.SinkProtocolInfo).toContain('x-sonosapi-radio:*:audio/x-sonosapi-radio:*');
        done();
      })
