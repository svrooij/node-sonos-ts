...
import { RenderingControlService } from '../../services/rendering-control.service.extension';
...
describe('RenderingControlService', () => {
  describe('GetBass', () => {
    it('works', async () => {
      ...
      expect(response.CurrentBass).toBe(0);
    })
  })
  describe('GetHeadphoneConnected', () => {
    it('works', async () => {
      ...
      expect(response.CurrentHeadphoneConnected).toBe(false);
    })
  })
  ...
  describe('GetLoudness()', () => {
    it('works', async () => {
      ...
      expect(result.CurrentLoudness).toBe(false);
    });
  });
  ...
  describe('GetMute', () => {
    it('works', async () => {
      ...
      expect(response.CurrentMute).toBeTruthy();
    })
  });
  ...
  describe('GetOutputFixed()', () => {
    it('works', async () => {
      ...
      expect(result.CurrentFixed).toBe(false);
    });
  });
  ...
  describe('GetRoomCalibrationStatus()', () => {
    it('returns false for 0', async () => {
      ...
      expect(result.RoomCalibrationAvailable).toBe(false);
    });
    ...
    it('returns true for 1', async () => {
      ...
      const result = await service.GetRoomCalibrationStatus({ InstanceID:0 });
      expect(result.RoomCalibrationAvailable).toBeTruthy();
    });
  });
  ...
  describe('GetOutputFixed()', () => {
    it('works', async () => {
      ...
      expect(result.CurrentSupportsFixed).toBe(false);
    });
  });
  ...
  describe('GetTreble()', () => {
    it('works', async () => {
      ...
      expect(result.CurrentTreble).toEqual(0);
    });
  });
  ...
  describe('GetVolume', () => {
    it('works', async () => {
      ...
      expect(response.CurrentVolume).toEqual(15);
    })
  })
  ...
  describe('ResetBasicEQ', () => {
    it('works', async () => {
      ...
      expect(response.Bass).toEqual(0);
      expect(response.Treble).toEqual(0);
      expect(response.Loudness).toBeTruthy();
      expect(response.LeftVolume).toEqual(100);
      expect(response.RightVolume).toEqual(100);
    })
  })
  ...
  describe('SetRelativeVolume', () => {
    it('works', async () => {
      ...
      expect(response.NewVolume).toEqual(11);
    })
  })
  ...
  describe('Event parsing', () => {
    it('works', (done) => {
      ...
      service.Events.once('serviceEvent', (data) => {
        expect(data.Volume?.Master).toEqual(15)
        expect(data.Mute?.Master).toBe(false);
        expect(data.PresetNameList).toEqual('FactoryDefaults')
        done()
      })
