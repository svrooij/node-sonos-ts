...
import { ContentDirectoryService } from '../../services/content-directory.service.extension';
...
describe('ContentDirectoryService', () => {
  ...
  describe('BrowseParsedWithDefaults', () => {
    it('browse for Eminem works', async () => {
      ...
      expect(result.NumberReturned).toEqual(4);
      expect(result.Result[1]).toHaveProperty('Title', 'Encore');
      expect(result.Result[1]).toHaveProperty('ProtocolInfo', 'x-rincon-playlist:*:*:*');
    });
    ...
    it('search for Eminem works', async () => {
      ...
      const result = await service.BrowseParsedWithDefaults('A:ARTIST:eminem');
      expect(result.NumberReturned).toEqual(15);
      expect(result.Result[0]).toHaveProperty('Title', 'Eminem');
    });
  });
  ...
  describe('GetAlbumArtistDisplayOption()', () => {
    it('works', async () => {
      ...
      expect(result.AlbumArtistDisplayOption).toEqual('WMP');
    });
  });
  ...
  describe('GetBrowseable()', () => {
    it('works', async () => {
      ...
      expect(result.IsBrowseable).toBe(true);
    });
  });
  ...
  describe('GetLastIndexChange()', () => {
    it('works', async () => {
      ...
      expect(result.LastIndexChange).toEqual('F2022-01-07 05:00:00');
    });
  });
  ...
  describe('GetSearchCapabilities()', () => {
    it('works', async () => {
      ...
      expect(result).toHaveProperty('SearchCaps');
    });
  });
  ...
  describe('GetSortCapabilities()', () => {
    it('works', async () => {
      ...
      expect(result).toHaveProperty('SortCaps');
    });
  });
  ...
  //       expect(data.Browseable).toEqual(true);
