...
export class AVTransportService extends BaseService {
  ...
  // Actions
  AddMultipleURIsToQueue(input: { InstanceID: number; UpdateID: number; NumberOfURIs: number; EnqueuedURIs: string; EnqueuedURIsMetaData: string | Track; ContainerURI: string; ContainerMetaData: string | Track; DesiredFirstTrackNumberEnqueued: number; EnqueueAsNext: boolean }): Promise<AddMultipleURIsToQueueResponse> { return this.SoapRequestWithBody<typeof input, AddMultipleURIsToQueueResponse>('AddMultipleURIsToQueue', input); }
  AddURIToQueue(input: { InstanceID: number; EnqueuedURI: string; EnqueuedURIMetaData: string | Track; DesiredFirstTrackNumberEnqueued: number; EnqueueAsNext: boolean }): Promise<AddURIToQueueResponse> { return this.SoapRequestWithBody<typeof input, AddURIToQueueResponse>('AddURIToQueue', input); }
  AddURIToSavedQueue(input: { InstanceID: number; ObjectID: string; UpdateID: number; EnqueuedURI: string; EnqueuedURIMetaData: string | Track; AddAtIndex: number }): Promise<AddURIToSavedQueueResponse> { return this.SoapRequestWithBody<typeof input, AddURIToSavedQueueResponse>('AddURIToSavedQueue', input); }
  ...
  BecomeGroupCoordinatorAndSource(input: { InstanceID: number; CurrentCoordinator: string; CurrentGroupID: string; OtherMembers: string; CurrentURI: string; CurrentURIMetaData: string | Track; SleepTimerState: string; AlarmState: string; StreamRestartState: string; CurrentAVTTrackList: string; CurrentQueueTrackList: string; CurrentSourceState: string; ResumePlayback: boolean }): Promise<boolean> { return this.SoapRequestWithBodyNoResponse<typeof input>('BecomeGroupCoordinatorAndSource', input); }
  ...
  CreateSavedQueue(input: { InstanceID: number; Title: string; EnqueuedURI: string; EnqueuedURIMetaData: string | Track }): Promise<CreateSavedQueueResponse> { return this.SoapRequestWithBody<typeof input, CreateSavedQueueResponse>('CreateSavedQueue', input); }
  ...
  RunAlarm(input: { InstanceID: number; AlarmID: number; LoggedStartTime: string; Duration: string; ProgramURI: string; ProgramMetaData: string | Track; PlayMode: string; Volume: number; IncludeLinkedZones: boolean }): Promise<boolean> { return this.SoapRequestWithBodyNoResponse<typeof input>('RunAlarm', input); }
  ...
  SetAVTransportURI(input: { InstanceID: number; CurrentURI: string; CurrentURIMetaData: string | Track }): Promise<boolean> { return this.SoapRequestWithBodyNoResponse<typeof input>('SetAVTransportURI', input); }
  ...
  SetNextAVTransportURI(input: { InstanceID: number; NextURI: string; NextURIMetaData: string | Track }): Promise<boolean> { return this.SoapRequestWithBodyNoResponse<typeof input>('SetNextAVTransportURI', input); }
  ...
  StartAutoplay(input: { InstanceID: number; ProgramURI: string; ProgramMetaData: string | Track; Volume: number; IncludeLinkedZones: boolean; ResetVolumeAfter: boolean }): Promise<boolean> { return this.SoapRequestWithBodyNoResponse<typeof input>('StartAutoplay', input); }
